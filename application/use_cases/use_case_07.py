...
def execute(
    ...
    # Tunning scenario 03
    setup.create_tunning_scenario_03(clusterless_conn)
    setup.create_tunning_scenario_03(master_cluster_conn)
  
    
    report_dir_path = os.path.join(os.path.dirname(__file__), '../reports/use_case_07')
